...
[![Live demo: Flai-hosted data](https://img.shields.io/badge/live%20demo-Flai--hosted%20data-2b8a3e.svg)](https://flol3622.github.io/DHMVII_potree-next/)

### [▶ Open the live viewer](https://flol3622.github.io/DHMVII_potree-next/)

<sub>The live demo runs the [`feat/flai-dhmvii-source`](https://github.com/flol3622/DHMVII_potree-next/tree/feat/flai-dhmvii-source) branch — see [below](#-live-demo-the-featflai-dhmvii-source-branch).</sub>
...
## 🌿 Live demo: the `feat/flai-dhmvii-source` branch
